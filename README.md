...
Calculations of the program are based on [Solar Region Summary](https://www.swpc.noaa.gov/products/solar-region-summary) data provided by NOAA. Instead of using daily summary files, the program use [solar_regions.json](https://services.swpc.noaa.gov/json/solar_regions.json) file that is a reagion summary collection from a month. There is available [a user guide](https://www.swpc.noaa.gov/sites/default/files/images/u2/Usr_guide.pdf) that explains backgrounds of the data.
